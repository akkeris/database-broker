...
begin
    ...
    if (select count(*) from plans) = 0 then
        ...
        values 
            ('50660450-61d3-2c13-a3fd-d379997932fb', '01bb60d2-f2bb-64c0-4c8b-ead731a690bc', 'hobby-v9',      'Hobby (9.6)',        'Postgres 9.6.6 - 1xCPU 1GB Ram 512MB Storage', '9.6.6', 'postgres', 'postgres', 'Data Stores', 0,     '{"compliance":"", "supports_extensions":false, "ram":"1GB",   "database_replicas":false, "database_logs":false, "restartable":false, "row_limits":null, "storage_capacity":"512MB", "data_clips":false, "connection_limit":20,   "high_availability":false,  "rollback":"7 days",  "encryption_at_rest":true, "high_speed_ssd":false, "burstable_performance":true,  "dedicated":false }', 'postgres-shared', '{"master_uri":"${PG_HOBBY_9_URI}", "engine":"postgres", "engine_version":"9.6.6"}'),
            ('a329070d-8caa-2c1e-1897-2c6b15907845', '01bb60d2-f2bb-64c0-4c8b-ead731a690bc', 'standard-0-v9', 'Standard-0 (9.6)',   'Postgres 9.6.6 - 1xCPU 2GB Ram 4GB Storage',   '9.6.6', 'postgres', 'postgres', 'Data Stores', 500,   '{"compliance":"", "supports_extensions":false, "ram":"2GB",   "database_replicas":false, "database_logs":false, "restartable":false, "row_limits":null, "storage_capacity":"4GB",   "data_clips":false, "connection_limit":50,   "high_availability":true,   "rollback":"7 days",  "encryption_at_rest":true, "high_speed_ssd":false, "burstable_performance":true,  "dedicated":false }', 'postgres-shared', '{"master_uri":"${PG_HOBBY_9_URI}", "engine":"postgres", "engine_version":"9.6.6"}'),
            ('c4330196-7d00-b529-4217-edc9c4b7b2d4', '01bb60d2-f2bb-64c0-4c8b-ead731a690bc', 'standard-1-v9', 'Standard-1 (9.6)',   'Postgres 9.6.6 - 1xCPU 2GB Ram 16GB Storage',  '9.6.6', 'postgres', 'postgres', 'Data Stores', 1500,  '{"compliance":"", "supports_extensions":false, "ram":"2GB",   "database_replicas":false, "database_logs":false, "restartable":false, "row_limits":null, "storage_capacity":"16GB",  "data_clips":false, "connection_limit":100,  "high_availability":true,   "rollback":"7 days",  "encryption_at_rest":true, "high_speed_ssd":false, "burstable_performance":true,  "dedicated":false }', 'postgres-shared', '{"master_uri":"${PG_HOBBY_9_URI}", "engine":"postgres", "engine_version":"9.6.6"}'),
        ...
        insert into plans 
            (plan, service, name, human_name, description, version, type, scheme, categories, cost_cents, attributes, provider, provider_private_details)
        values 
            ('a0660450-61d3-2c13-a3fd-d379997932f1', '01bb60d2-f2bb-64c0-4c8b-ead731a690bc', 'hobby',         'Hobby (10.4)',        'Postgres 10.4 - 1xCPU 1GB Ram 512MB Storage', '10.4', 'postgres', 'postgres', 'Data Stores', 0,     '{"compliance":"", "supports_extensions":false, "ram":"1GB",   "database_replicas":false, "database_logs":false, "restartable":false, "row_limits":null, "storage_capacity":"512MB", "data_clips":false, "connection_limit":20,   "high_availability":false,  "rollback":"7 days",  "encryption_at_rest":true, "high_speed_ssd":false, "burstable_performance":true,  "dedicated":false }', 'postgres-shared', '{"master_uri":"${PG_HOBBY_10_URI}", "engine":"postgres", "engine_version":"10.4"}'),
            ('b329070d-8caa-2c1e-1897-2c6b15907842', '01bb60d2-f2bb-64c0-4c8b-ead731a690bc', 'standard-0',    'Standard-0 (10.4)',   'Postgres 10.4 - 1xCPU 2GB Ram 4GB Storage',   '10.4', 'postgres', 'postgres', 'Data Stores', 500,   '{"compliance":"", "supports_extensions":false, "ram":"2GB",   "database_replicas":false, "database_logs":false, "restartable":false, "row_limits":null, "storage_capacity":"4GB",   "data_clips":false, "connection_limit":50,   "high_availability":true,   "rollback":"7 days",  "encryption_at_rest":true, "high_speed_ssd":false, "burstable_performance":true,  "dedicated":false }', 'postgres-shared', '{"master_uri":"${PG_HOBBY_10_URI}", "engine":"postgres", "engine_version":"10.4"}'),
            ('c4330196-7d00-b529-4217-edc9c4b7b2d3', '01bb60d2-f2bb-64c0-4c8b-ead731a690bc', 'standard-1',    'Standard-1 (10.4)',   'Postgres 10.4 - 1xCPU 2GB Ram 16GB Storage',  '10.4', 'postgres', 'postgres', 'Data Stores', 1500,  '{"compliance":"", "supports_extensions":false, "ram":"2GB",   "database_replicas":false, "database_logs":false, "restartable":false, "row_limits":null, "storage_capacity":"16GB",  "data_clips":false, "connection_limit":100,  "high_availability":true,   "rollback":"7 days",  "encryption_at_rest":true, "high_speed_ssd":false, "burstable_performance":true,  "dedicated":false }', 'postgres-shared', '{"master_uri":"${PG_HOBBY_10_URI}", "engine":"postgres", "engine_version":"10.4"}'),

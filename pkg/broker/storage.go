    ...
    if (select count(*) from plans) = 0 then
        ...
        values 
            ...
            ('13c42a36-e61d-6fa4-7d89-1c774aeec01a', '01bb60d2-f2bb-64c0-4c8b-ead731a690bd', 'premium-2',     'Premium-2 (10.4)',    'Postgres 10.4 - 4xCPU 16GB Ram 100GB Storage','10.4', 'postgres', 'postgres', 'Data Stores', 72000, 0, '{"compliance":"", "supports_extensions":true,  "ram":"16GB",  "database_replicas":true,  "database_logs":true,  "restartable":true,  "row_limits":null, "storage_capacity":"100GB", "data_clips":true,  "connection_limit":null, "high_availability":true,   "rollback":"14 days", "encryption_at_rest":true, "high_speed_ssd":true,  "burstable_performance":false, "dedicated":true  }', 'aws-instance',    '{"AllocatedStorage":100,"AutoMinorVersionUpgrade":true,"AvailabilityZone":null,"BackupRetentionPeriod":14,"CharacterSetName":null,"CopyTagsToSnapshot":true,"DBClusterIdentifier":null,"DBInstanceClass":"db.m4.large","DBInstanceIdentifier":null,"DBName":null,"DBParameterGroupName":null,"DBSecurityGroups":null,"DBSubnetGroupName":"rds-postgres-subnet-group","Domain":null,"DomainIAMRoleName":null,"EnableCloudwatchLogsExports":null,"EnableIAMDatabaseAuthentication":null,"EnablePerformanceInsights":true,"Engine":"postgres","EngineVersion":"10.4","Iops":1000,"KmsKeyId":null,"LicenseModel":null,"MasterUserPassword":null,"MasterUsername":null,"MonitoringInterval":null,"MonitoringRoleArn":null,"MultiAZ":true,"OptionGroupName":null,"PerformanceInsightsKMSKeyId":null,"PerformanceInsightsRetentionPeriod":7,"Port":null,"PreferredBackupWindow":null,"PreferredMaintenanceWindow":null,"ProcessorFeatures":null,"PromotionTier":null,"PubliclyAccessible":false,"StorageEncrypted":true,"StorageType":"io1","Tags":null,"TdeCredentialArn":null,"TdeCredentialPassword":null,"Timezone":null,"VpcSecurityGroupIds":null}');
				...
				insert into plans
				    (plan, service, name, human_name, description, version, type, scheme, categories, cost_cents, preprovision, attributes, provider, provider_private_details)
				values 
						('a0cf34ac-f51f-4575-8570-1dc6a3f9fe4a', '01bb60d2-f2bb-64c0-4c8b-ead731a690bd', 'hobby',         'Hobby (12.3)',        'Postgres 12.3 - 1xCPU 1GB Ram 512MB Storage', '12.3', 'postgres', 'postgres', 'Data Stores', 0,     0, '{"compliance":"", "supports_extensions":false, "ram":"1GB",   "database_replicas":false, "database_logs":false, "restartable":false, "row_limits":null, "storage_capacity":"512MB", "data_clips":false, "connection_limit":20,   "high_availability":false,  "rollback":"7 days",  "encryption_at_rest":true, "high_speed_ssd":false, "burstable_performance":true,  "dedicated":false }', 'postgres-shared', '{"master_uri":"${PG_HOBBY_12_3_URI}", "engine":"postgres", "engine_version":"12.3"}'),
						('7a2b87d8-b7d6-4d6a-ad13-7702f64a592b', '01bb60d2-f2bb-64c0-4c8b-ead731a690bd', 'standard-0',    'Standard-0 (12.3)',   'Postgres 12.3 - 1xCPU 2GB Ram 4GB Storage',   '12.3', 'postgres', 'postgres', 'Data Stores', 500,   0, '{"compliance":"", "supports_extensions":false, "ram":"2GB",   "database_replicas":false, "database_logs":false, "restartable":false, "row_limits":null, "storage_capacity":"4GB",   "data_clips":false, "connection_limit":50,   "high_availability":true,   "rollback":"7 days",  "encryption_at_rest":true, "high_speed_ssd":false, "burstable_performance":true,  "dedicated":false }', 'postgres-shared', '{"master_uri":"${PG_HOBBY_12_3_URI}", "engine":"postgres", "engine_version":"12.3"}'),
						('5915ce83-a1f4-432f-9881-6535c768d1ea', '01bb60d2-f2bb-64c0-4c8b-ead731a690bd', 'standard-1',    'Standard-1 (12.3)',   'Postgres 12.3 - 1xCPU 2GB Ram 16GB Storage',  '12.3', 'postgres', 'postgres', 'Data Stores', 1500,  0, '{"compliance":"", "supports_extensions":false, "ram":"2GB",   "database_replicas":false, "database_logs":false, "restartable":false, "row_limits":null, "storage_capacity":"16GB",  "data_clips":false, "connection_limit":100,  "high_availability":true,   "rollback":"7 days",  "encryption_at_rest":true, "high_speed_ssd":false, "burstable_performance":true,  "dedicated":false }', 'postgres-shared', '{"master_uri":"${PG_HOBBY_12_3_URI}", "engine":"postgres", "engine_version":"12.3"}'),
						('871c82a8-2e71-440b-adb0-68f169ba0f45', '01bb60d2-f2bb-64c0-4c8b-ead731a690bd', 'standard-2',    'Standard-2 (12.3)',   'Postgres 12.3 - 1xCPU 4GB Ram 32GB Storage',  '12.3', 'postgres', 'postgres', 'Data Stores', 4500,  0, '{"compliance":"", "supports_extensions":false, "ram":"4GB",   "database_replicas":false, "database_logs":false, "restartable":false, "row_limits":null, "storage_capacity":"32GB",  "data_clips":false, "connection_limit":200,  "high_availability":true,   "rollback":"7 days",  "encryption_at_rest":true, "high_speed_ssd":true,  "burstable_performance":true,  "dedicated":false }', 'postgres-shared', '{"master_uri":"${PG_HOBBY_12_3_URI}", "engine":"postgres", "engine_version":"12.3"}');
		...
		if (select count(*) from plans where plan = '0b74a5e8-ad17-4209-bc61-a08520c3cc1f') = 0 then
			insert into plans
				(plan, service, name, human_name, description, version, type, scheme, categories, cost_cents, preprovision, attributes, provider, provider_private_details)
			values
				('0b74a5e8-ad17-4209-bc61-a08520c3cc1f', '01bb60d2-f2bb-64c0-4c8b-ead731a690bd', 'premium-nano-0',  'Premium-Nano-0 (11.6)', 'Postgres 11.6 - 2xCPU 2GB Ram 20GB Storage', '11.6', 'postgres', 'postgres', 'Data Stores', 2000,  0, '{"compliance":"", "supports_extensions":true,  "ram":"2GB",   "database_replicas":true,  "database_logs":true,  "restartable":true,  "row_limits":null, "storage_capacity":"20GB",  "data_clips":true,  "connection_limit":null, "high_availability":false,  "rollback":"14 days", "encryption_at_rest":true, "high_speed_ssd":true,  "burstable_performance":false, "dedicated":true  }', 'aws-instance',    '{"AllocatedStorage":20,"AutoMinorVersionUpgrade":true,"AvailabilityZone":null,"BackupRetentionPeriod":14,"CharacterSetName":null,"CopyTagsToSnapshot":true,"DBClusterIdentifier":null,"DBInstanceClass":"db.t3.small","DBInstanceIdentifier":null,"DBName":null,"DBParameterGroupName":null,"DBSecurityGroups":null,"DBSubnetGroupName":"rds-postgres-subnet-group","Domain":null,"DomainIAMRoleName":null,"EnableCloudwatchLogsExports":null,"EnableIAMDatabaseAuthentication":null,"EnablePerformanceInsights":false,"Engine":"postgres","EngineVersion":"11.6","Iops":null,"KmsKeyId":null,"LicenseModel":null,"MasterUserPassword":null,"MasterUsername":null,"MonitoringInterval":null,"MonitoringRoleArn":null,"MultiAZ":false,"OptionGroupName":null,"PerformanceInsightsKMSKeyId":null,"PerformanceInsightsRetentionPeriod":null,"Port":null,"PreferredBackupWindow":null,"PreferredMaintenanceWindow":null,"ProcessorFeatures":null,"PromotionTier":null,"PubliclyAccessible":false,"StorageEncrypted":true,"StorageType":"gp2","Tags":null,"TdeCredentialArn":null,"TdeCredentialPassword":null,"Timezone":null,"VpcSecurityGroupIds":null}');
		end if;

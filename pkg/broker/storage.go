...
begin
    ...
    if (select count(*) from plans) = 0 then
        ...
        values 
            ...
            ('d294d7f1-19b4-f72c-e3bd-96970f74f027', '01bb60d2-f2bb-64c0-4c8b-ead731a690bc', 'premium-0-v9',  'Premium-1 (9.5)',    'Postgres 9.5.2 - 2xCPU 4GB Ram 20GB Storage',  '9.5.2', 'postgres', 'postgres', 'Data Stores', 6000,  '{"compliance":"", "supports_extensions":true,  "ram":"4GB",   "database_replicas":true,  "database_logs":true,  "restartable":true,  "row_limits":null, "storage_capacity":"20GB",  "data_clips":true,  "connection_limit":null, "high_availability":false,  "rollback":"14 days", "encryption_at_rest":true, "high_speed_ssd":true,  "burstable_performance":false, "dedicated":true  }', 'aws-instance',    '{ "db_instance_class":"db.t2.medium", "engine":"postgres", "engine_version":"9.6.9", "allocated_storage":20,  "multi_az":false, "auto_minor_version_upgrade":true, "publicaly_accessible":false, "storage_encrypted":true, "copy_tags_to_snapshot":true, "backup_retention_period":14, "enable_performance_insights":false, "performance_insights_retention_period":7, "dbparmaeter_group_name":"rds-postgres-96", "dbsubnet_group_name":"rds-postgres-subnet-group", "storage_type":"gp2" }' ),
            ('682631dd-0374-e495-f1f6-f16406962873', '01bb60d2-f2bb-64c0-4c8b-ead731a690bc', 'premium-1-v9',  'Premium-2 (9.5)',    'Postgres 9.5.2 - 2xCPU 8GB Ram 50GB Storage',  '9.5.2', 'postgres', 'postgres', 'Data Stores', 13500, '{"compliance":"", "supports_extensions":true,  "ram":"8GB",   "database_replicas":true,  "database_logs":true,  "restartable":true,  "row_limits":null, "storage_capacity":"50GB",  "data_clips":true,  "connection_limit":null, "high_availability":false,  "rollback":"14 days", "encryption_at_rest":true, "high_speed_ssd":true,  "burstable_performance":false, "dedicated":true  }', 'aws-instance',    '{ "db_instance_class":"db.m4.large",  "engine":"postgres", "engine_version":"9.6.9", "allocated_storage":50,  "multi_az":false, "auto_minor_version_upgrade":true, "publicaly_accessible":false, "storage_encrypted":true, "copy_tags_to_snapshot":true, "backup_retention_period":14, "enable_performance_insights":true, "performance_insights_retention_period":7, "dbparmaeter_group_name":"rds-postgres-96", "dbsubnet_group_name":"rds-postgres-subnet-group", "storage_type":"gp2" }' ),
            ('53c42a36-e61d-6fa4-7d89-1c774aeec016', '01bb60d2-f2bb-64c0-4c8b-ead731a690bc', 'premium-2-v9',  'Premium-3 (9.5)',    'Postgres 9.5.2 - 4xCPU 16GB Ram 100GB Storage','9.5.2', 'postgres', 'postgres', 'Data Stores', 72000, '{"compliance":"", "supports_extensions":true,  "ram":"16GB",  "database_replicas":true,  "database_logs":true,  "restartable":true,  "row_limits":null, "storage_capacity":"100GB", "data_clips":true,  "connection_limit":null, "high_availability":true,   "rollback":"14 days", "encryption_at_rest":true, "high_speed_ssd":true,  "burstable_performance":false, "dedicated":true  }', 'aws-instance',    '{ "db_instance_class":"db.m4.large",  "engine":"postgres", "engine_version":"9.6.9", "allocated_storage":100, "multi_az":true,  "auto_minor_version_upgrade":true, "publicaly_accessible":false, "storage_encrypted":true, "copy_tags_to_snapshot":true, "backup_retention_period":14, "enable_performance_insights":true, "performance_insights_retention_period":7, "dbparmaeter_group_name":"rds-postgres-96", "dbsubnet_group_name":"rds-postgres-subnet-group", "storage_type":"io1", "iops":1000 }');
        ...
        values 
            ...
            ('e294d7f1-19b4-f72c-e3bd-96970f74f025', '01bb60d2-f2bb-64c0-4c8b-ead731a690bc', 'premium-0',     'Premium-1 (10.4)',    'Postgres 10.4 - 2xCPU 4GB Ram 20GB Storage',  '10.4', 'postgres', 'postgres', 'Data Stores', 6000,  '{"compliance":"", "supports_extensions":true,  "ram":"4GB",   "database_replicas":true,  "database_logs":true,  "restartable":true,  "row_limits":null, "storage_capacity":"20GB",  "data_clips":true,  "connection_limit":null, "high_availability":false,  "rollback":"14 days", "encryption_at_rest":true, "high_speed_ssd":true,  "burstable_performance":false, "dedicated":true  }', 'aws-instance',    '{ "db_instance_class":"db.t2.medium", "engine":"postgres", "engine_version":"10.4", "allocated_storage":20,  "multi_az":false, "auto_minor_version_upgrade":true, "publicaly_accessible":false, "storage_encrypted":true, "copy_tags_to_snapshot":true, "backup_retention_period":14, "enable_performance_insights":false, "performance_insights_retention_period":7, "dbparmaeter_group_name":"rds-postgres-10", "dbsubnet_group_name":"rds-postgres-subnet-group", "storage_type":"gp2" }' ),
            ('f82631dd-0374-e495-f1f6-f16406962876', '01bb60d2-f2bb-64c0-4c8b-ead731a690bc', 'premium-1',     'Premium-2 (10.4)',    'Postgres 10.4 - 2xCPU 8GB Ram 50GB Storage',  '10.4', 'postgres', 'postgres', 'Data Stores', 13500, '{"compliance":"", "supports_extensions":true,  "ram":"8GB",   "database_replicas":true,  "database_logs":true,  "restartable":true,  "row_limits":null, "storage_capacity":"50GB",  "data_clips":true,  "connection_limit":null, "high_availability":false,  "rollback":"14 days", "encryption_at_rest":true, "high_speed_ssd":true,  "burstable_performance":false, "dedicated":true  }', 'aws-instance',    '{ "db_instance_class":"db.m4.large",  "engine":"postgres", "engine_version":"10.4", "allocated_storage":50,  "multi_az":false, "auto_minor_version_upgrade":true, "publicaly_accessible":false, "storage_encrypted":true, "copy_tags_to_snapshot":true, "backup_retention_period":14, "enable_performance_insights":true, "performance_insights_retention_period":7, "dbparmaeter_group_name":"rds-postgres-10", "dbsubnet_group_name":"rds-postgres-subnet-group", "storage_type":"gp2" }' ),
            ('13c42a36-e61d-6fa4-7d89-1c774aeec017', '01bb60d2-f2bb-64c0-4c8b-ead731a690bc', 'premium-2',     'Premium-3 (10.4)',    'Postgres 10.4 - 4xCPU 16GB Ram 100GB Storage','10.4', 'postgres', 'postgres', 'Data Stores', 72000, '{"compliance":"", "supports_extensions":true,  "ram":"16GB",  "database_replicas":true,  "database_logs":true,  "restartable":true,  "row_limits":null, "storage_capacity":"100GB", "data_clips":true,  "connection_limit":null, "high_availability":true,   "rollback":"14 days", "encryption_at_rest":true, "high_speed_ssd":true,  "burstable_performance":false, "dedicated":true  }', 'aws-instance',    '{ "db_instance_class":"db.m4.large",  "engine":"postgres", "engine_version":"10.4", "allocated_storage":100, "multi_az":true,  "auto_minor_version_upgrade":true, "publicaly_accessible":false, "storage_encrypted":true, "copy_tags_to_snapshot":true, "backup_retention_period":14, "enable_performance_insights":true, "performance_insights_retention_period":7, "dbparmaeter_group_name":"rds-postgres-10", "dbsubnet_group_name":"rds-postgres-subnet-group", "storage_type":"io1", "iops":1000 }');
    end if;
end
$$
`;
